...
type League = { id: string; name: string; admin_id: string; member_ids: string[]; code: string; mode?: 'asta' | 'listino'; transfer_window_open?: boolean; kickoff_locked?: boolean; start_matchday?: number; end_matchday?: number } | null;
